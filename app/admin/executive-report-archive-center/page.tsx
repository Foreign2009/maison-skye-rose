...
import ExecutiveReportArchiveCenter          from "@/app/admin/ExecutiveReportArchiveCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Archive Center | Maison Skye & Rose",
...
export default async function ExecutiveReportArchiveCenterPage() {
  ...
  return <ExecutiveReportArchiveCenter archive={archive} />;
}
