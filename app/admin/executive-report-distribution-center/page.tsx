...
import ExecutiveReportDistributionCenter     from "@/app/admin/ExecutiveReportDistributionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Distribution Center | Maison Skye & Rose",
...
export default async function ExecutiveReportDistributionCenterPage() {
  ...
  return <ExecutiveReportDistributionCenter distribution={distribution} />;
}
