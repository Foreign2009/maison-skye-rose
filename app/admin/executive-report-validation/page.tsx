...
import ExecutiveReportValidationDashboard         from "@/app/admin/ExecutiveReportValidationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Validation | Maison Skye & Rose",
...
export default async function ExecutiveReportValidationPage() {
  ...
  return <ExecutiveReportValidationDashboard validation={validation} />;
}
