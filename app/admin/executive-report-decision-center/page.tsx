...
import ExecutiveReportDecisionCenter         from "@/app/admin/ExecutiveReportDecisionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Decision Center | Maison Skye & Rose",
...
export default async function ExecutiveReportDecisionCenterPage() {
  ...
  return <ExecutiveReportDecisionCenter decision={decision} />;
}
