...
import ExecutiveReportStrategyCenter         from "@/app/admin/ExecutiveReportStrategyCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Strategy Center | Maison Skye & Rose",
...
export default async function ExecutiveReportStrategyCenterPage() {
  ...
  return <ExecutiveReportStrategyCenter strategy={strategy} />;
}
