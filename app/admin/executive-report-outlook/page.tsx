...
import ExecutiveReportOutlookDashboard       from "@/app/admin/ExecutiveReportOutlookDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Outlook | Maison Skye & Rose",
...
export default async function ExecutiveReportOutlookPage() {
  ...
  return <ExecutiveReportOutlookDashboard outlook={outlook} />;
}
