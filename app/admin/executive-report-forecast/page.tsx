...
import ExecutiveReportForecastDashboard      from "@/app/admin/ExecutiveReportForecastDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Forecast | Maison Skye & Rose",
...
export default async function ExecutiveReportForecastPage() {
  ...
  return <ExecutiveReportForecastDashboard forecast={forecast} />;
}
