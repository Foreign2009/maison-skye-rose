...
import ExecutiveReportAcknowledgementCenter       from "@/app/admin/ExecutiveReportAcknowledgementCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Acknowledgement Center | Maison Skye & Rose",
...
export default async function ExecutiveReportAcknowledgementCenterPage() {
  ...
  return <ExecutiveReportAcknowledgementCenter acknowledgement={acknowledgement} />;
}
