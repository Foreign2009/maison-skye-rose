...
import ExecutiveReportHistoryCenter          from "@/app/admin/ExecutiveReportHistoryCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report History Center | Maison Skye & Rose",
...
export default async function ExecutiveReportHistoryCenterPage() {
  ...
  return <ExecutiveReportHistoryCenter history={history} />;
}
