...
import ExecutiveReportRatificationCenter          from "@/app/admin/ExecutiveReportRatificationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Ratification Center | Maison Skye & Rose",
...
export default async function ExecutiveReportRatificationCenterPage() {
  ...
  return <ExecutiveReportRatificationCenter ratification={ratification} />;
}
