...
import ExecutiveReportCenter              from "@/app/admin/ExecutiveReportCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Center | Maison Skye & Rose",
...
export default async function ExecutiveReportCenterPage() {
  ...
  return <ExecutiveReportCenter report={report} />;
}
