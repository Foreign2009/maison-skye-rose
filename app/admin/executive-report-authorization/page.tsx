...
import ExecutiveReportAuthorizationDashboard      from "@/app/admin/ExecutiveReportAuthorizationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Authorization | Maison Skye & Rose",
...
export default async function ExecutiveReportAuthorizationPage() {
  ...
  return <ExecutiveReportAuthorizationDashboard authorization={authorization} />;
}
