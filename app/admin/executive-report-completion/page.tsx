...
import ExecutiveReportCompletionDashboard    from "@/app/admin/ExecutiveReportCompletionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Completion | Maison Skye & Rose",
...
export default async function ExecutiveReportCompletionPage() {
  ...
  return <ExecutiveReportCompletionDashboard completion={completion} />;
}
