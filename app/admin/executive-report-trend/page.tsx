...
import ExecutiveReportTrendDashboard         from "@/app/admin/ExecutiveReportTrendDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Trend | Maison Skye & Rose",
...
export default async function ExecutiveReportTrendPage() {
  ...
  return <ExecutiveReportTrendDashboard trend={trend} />;
}
