...
import ExecutiveReportComparisonCenter       from "@/app/admin/ExecutiveReportComparisonCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Comparison Center | Maison Skye & Rose",
...
export default async function ExecutiveReportComparisonCenterPage() {
  ...
  return <ExecutiveReportComparisonCenter comparison={comparison} />;
}
