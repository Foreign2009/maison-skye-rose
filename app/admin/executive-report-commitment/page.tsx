...
import ExecutiveReportCommitmentDashboard         from "@/app/admin/ExecutiveReportCommitmentDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Commitment | Maison Skye & Rose",
...
export default async function ExecutiveReportCommitmentPage() {
  ...
  return <ExecutiveReportCommitmentDashboard commitment={commitment} />;
}
