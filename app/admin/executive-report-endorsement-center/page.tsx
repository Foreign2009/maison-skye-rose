...
import ExecutiveReportEndorsementCenter           from "@/app/admin/ExecutiveReportEndorsementCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Endorsement Center | Maison Skye & Rose",
...
export default async function ExecutiveReportEndorsementCenterPage() {
  ...
  return <ExecutiveReportEndorsementCenter endorsement={endorsement} />;
}
