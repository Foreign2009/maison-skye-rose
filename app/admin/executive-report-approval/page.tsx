...
import ExecutiveReportApprovalDashboard      from "@/app/admin/ExecutiveReportApprovalDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Approval | Maison Skye & Rose",
...
export default async function ExecutiveReportApprovalPage() {
  ...
  return <ExecutiveReportApprovalDashboard approval={approval} />;
}
