...
import ExecutiveReportAcceptanceDashboard         from "@/app/admin/ExecutiveReportAcceptanceDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Acceptance | Maison Skye & Rose",
...
export default async function ExecutiveReportAcceptancePage() {
  ...
  return <ExecutiveReportAcceptanceDashboard acceptance={acceptance} />;
}
