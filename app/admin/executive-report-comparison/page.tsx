...
import ExecutiveReportComparisonDashboard    from "@/app/admin/ExecutiveReportComparisonDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Comparison | Maison Skye & Rose",
...
export default async function ExecutiveReportComparisonPage() {
  ...
  return <ExecutiveReportComparisonDashboard comparison={comparison} />;
}
