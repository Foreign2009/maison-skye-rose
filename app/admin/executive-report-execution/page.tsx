...
import ExecutiveReportExecutionDashboard     from "@/app/admin/ExecutiveReportExecutionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Execution | Maison Skye & Rose",
...
export default async function ExecutiveReportExecutionPage() {
  ...
  return <ExecutiveReportExecutionDashboard execution={execution} />;
}
