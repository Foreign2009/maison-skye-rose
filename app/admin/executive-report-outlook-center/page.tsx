...
import ExecutiveReportOutlookCenter          from "@/app/admin/ExecutiveReportOutlookCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Outlook Center | Maison Skye & Rose",
...
export default async function ExecutiveReportOutlookCenterPage() {
  ...
  return <ExecutiveReportOutlookCenter outlook={outlook} />;
}
