...
import ExecutiveReportAuthenticationCenter        from "@/app/admin/ExecutiveReportAuthenticationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Authentication Center | Maison Skye & Rose",
...
export default async function ExecutiveReportAuthenticationCenterPage() {
  ...
  return <ExecutiveReportAuthenticationCenter authentication={authentication} />;
}
