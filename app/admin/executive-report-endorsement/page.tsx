...
import ExecutiveReportEndorsementDashboard        from "@/app/admin/ExecutiveReportEndorsementDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Endorsement | Maison Skye & Rose",
...
export default async function ExecutiveReportEndorsementPage() {
  ...
  return <ExecutiveReportEndorsementDashboard endorsement={endorsement} />;
}
