...
import ExecutiveReportExecutionCenter        from "@/app/admin/ExecutiveReportExecutionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Execution Center | Maison Skye & Rose",
...
export default async function ExecutiveReportExecutionCenterPage() {
  ...
  return <ExecutiveReportExecutionCenter execution={execution} />;
}
