...
import ExecutiveReportRatificationDashboard       from "@/app/admin/ExecutiveReportRatificationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Ratification | Maison Skye & Rose",
...
export default async function ExecutiveReportRatificationPage() {
  ...
  return <ExecutiveReportRatificationDashboard ratification={ratification} />;
}
