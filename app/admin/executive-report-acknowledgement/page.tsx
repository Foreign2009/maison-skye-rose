...
import ExecutiveReportAcknowledgementDashboard    from "@/app/admin/ExecutiveReportAcknowledgementDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Acknowledgement | Maison Skye & Rose",
...
export default async function ExecutiveReportAcknowledgementPage() {
  ...
  return <ExecutiveReportAcknowledgementDashboard acknowledgement={acknowledgement} />;
}
