...
import ExecutiveReportDecisionDashboard      from "@/app/admin/ExecutiveReportDecisionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Decision | Maison Skye & Rose",
...
export default async function ExecutiveReportDecisionPage() {
  ...
  return <ExecutiveReportDecisionDashboard decision={decision} />;
}
