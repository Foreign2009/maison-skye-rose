...
import ExecutiveReportConfirmationDashboard       from "@/app/admin/ExecutiveReportConfirmationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Confirmation | Maison Skye & Rose",
...
export default async function ExecutiveReportConfirmationPage() {
  ...
  return <ExecutiveReportConfirmationDashboard confirmation={confirmation} />;
}
