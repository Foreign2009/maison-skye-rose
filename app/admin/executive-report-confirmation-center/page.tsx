...
import ExecutiveReportConfirmationCenter          from "@/app/admin/ExecutiveReportConfirmationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Confirmation Center | Maison Skye & Rose",
...
export default async function ExecutiveReportConfirmationCenterPage() {
  ...
  return <ExecutiveReportConfirmationCenter confirmation={confirmation} />;
}
