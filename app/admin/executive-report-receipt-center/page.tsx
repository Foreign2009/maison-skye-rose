...
import ExecutiveReportReceiptCenter               from "@/app/admin/ExecutiveReportReceiptCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Receipt Center | Maison Skye & Rose",
...
export default async function ExecutiveReportReceiptCenterPage() {
  ...
  return <ExecutiveReportReceiptCenter receipt={receipt} />;
}
