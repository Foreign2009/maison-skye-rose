...
import ExecutiveReportCertificationDashboard      from "@/app/admin/ExecutiveReportCertificationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Certification | Maison Skye & Rose",
...
export default async function ExecutiveReportCertificationPage() {
  ...
  return <ExecutiveReportCertificationDashboard certification={certification} />;
}
