...
import ExecutiveReportDeliveryCenter         from "@/app/admin/ExecutiveReportDeliveryCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Delivery Center | Maison Skye & Rose",
...
export default async function ExecutiveReportDeliveryCenterPage() {
  ...
  return <ExecutiveReportDeliveryCenter delivery={delivery} />;
}
