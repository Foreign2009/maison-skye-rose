...
import ExecutiveReportAuthorizationCenter         from "@/app/admin/ExecutiveReportAuthorizationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Authorization Center | Maison Skye & Rose",
...
export default async function ExecutiveReportAuthorizationCenterPage() {
  ...
  return <ExecutiveReportAuthorizationCenter authorization={authorization} />;
}
