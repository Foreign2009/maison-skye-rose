...
import ExecutiveReportForecastCenter         from "@/app/admin/ExecutiveReportForecastCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Forecast Center | Maison Skye & Rose",
...
export default async function ExecutiveReportForecastCenterPage() {
  ...
  return <ExecutiveReportForecastCenter forecast={forecast} />;
}
