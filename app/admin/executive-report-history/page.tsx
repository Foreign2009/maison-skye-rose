...
import ExecutiveReportHistoryDashboard       from "@/app/admin/ExecutiveReportHistoryDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report History | Maison Skye & Rose",
...
export default async function ExecutiveReportHistoryPage() {
  ...
  return <ExecutiveReportHistoryDashboard history={history} />;
}
