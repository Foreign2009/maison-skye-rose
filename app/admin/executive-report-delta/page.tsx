...
import ExecutiveReportDeltaDashboard         from "@/app/admin/ExecutiveReportDeltaDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Delta | Maison Skye & Rose",
...
export default async function ExecutiveReportDeltaPage() {
  ...
  return <ExecutiveReportDeltaDashboard delta={delta} />;
}
