...
import ExecutiveBriefingCenter            from "@/app/admin/ExecutiveBriefingCenter";
...
export const metadata: Metadata = {
  title:  "Executive Briefing Center | Maison Skye & Rose",
...
export default async function ExecutiveBriefingPage() {
  ...
  return <ExecutiveBriefingCenter digest={digest} />;
}
