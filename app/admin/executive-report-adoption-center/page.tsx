...
import ExecutiveReportAdoptionCenter              from "@/app/admin/ExecutiveReportAdoptionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Adoption Center | Maison Skye & Rose",
...
export default async function ExecutiveReportAdoptionCenterPage() {
  ...
  return <ExecutiveReportAdoptionCenter adoption={adoption} />;
}
