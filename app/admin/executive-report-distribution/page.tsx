...
import ExecutiveReportDistributionDashboard  from "@/app/admin/ExecutiveReportDistributionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Distribution | Maison Skye & Rose",
...
export default async function ExecutiveReportDistributionPage() {
  ...
  return <ExecutiveReportDistributionDashboard distribution={distribution} />;
}
