...
import ExecutiveReportStrategyDashboard      from "@/app/admin/ExecutiveReportStrategyDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Strategy | Maison Skye & Rose",
...
export default async function ExecutiveReportStrategyPage() {
  ...
  return <ExecutiveReportStrategyDashboard strategy={strategy} />;
}
