...
import ExecutiveReportDeltaCenter            from "@/app/admin/ExecutiveReportDeltaCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Delta Center | Maison Skye & Rose",
...
export default async function ExecutiveReportDeltaCenterPage() {
  ...
  return <ExecutiveReportDeltaCenter delta={delta} />;
}
