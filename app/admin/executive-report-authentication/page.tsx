...
import ExecutiveReportAuthenticationDashboard     from "@/app/admin/ExecutiveReportAuthenticationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Authentication | Maison Skye & Rose",
...
export default async function ExecutiveReportAuthenticationPage() {
  ...
  return <ExecutiveReportAuthenticationDashboard authentication={authentication} />;
}
