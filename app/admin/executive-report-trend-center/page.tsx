...
import ExecutiveReportTrendCenter            from "@/app/admin/ExecutiveReportTrendCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Trend Center | Maison Skye & Rose",
...
export default async function ExecutiveReportTrendCenterPage() {
  ...
  return <ExecutiveReportTrendCenter trend={trend} />;
}
