...
import ExecutiveReportCertificationCenter         from "@/app/admin/ExecutiveReportCertificationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Certification Center | Maison Skye & Rose",
...
export default async function ExecutiveReportCertificationCenterPage() {
  ...
  return <ExecutiveReportCertificationCenter certification={certification} />;
}
