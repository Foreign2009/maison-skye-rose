...
import ExecutiveReportAdoptionDashboard           from "@/app/admin/ExecutiveReportAdoptionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Adoption | Maison Skye & Rose",
...
export default async function ExecutiveReportAdoptionPage() {
  ...
  return <ExecutiveReportAdoptionDashboard adoption={adoption} />;
}
