...
import ExecutiveReportCompletionCenter       from "@/app/admin/ExecutiveReportCompletionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Completion Center | Maison Skye & Rose",
...
export default async function ExecutiveReportCompletionCenterPage() {
  ...
  return <ExecutiveReportCompletionCenter completion={completion} />;
}
