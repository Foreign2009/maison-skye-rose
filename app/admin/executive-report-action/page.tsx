...
import ExecutiveReportActionDashboard        from "@/app/admin/ExecutiveReportActionDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Action | Maison Skye & Rose",
...
export default async function ExecutiveReportActionPage() {
  ...
  return <ExecutiveReportActionDashboard action={action} />;
}
