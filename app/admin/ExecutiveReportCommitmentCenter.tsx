...
// -- Section 1: Commitment Workspace Overview ---------------------------------

function CommitmentWorkspaceOverviewSection({ commitment }: { commitment: ExecutiveReportCommitment }) {
  ...
  return (
    <section>
      ...
      <SectionHeading>Commitment Workspace Overview</SectionHeading>
      <p className="mt-2 mb-5 text-sm text-[#7b7480]">
        Workspace-level view of the executive report commitment pipeline. Refreshed on every page load.
      </p>
...
// -- Section 2: Executive Commitment Workspace --------------------------------

function ExecutiveCommitmentWorkspaceCard({ entry }: { entry: ExecutiveReportCommitmentEntry }) {
...
function ExecutiveCommitmentWorkspaceSection({ commitment }: { commitment: ExecutiveReportCommitment }) {
  if (commitment.records.length === 0) {
    return (
      <section>
        <SectionLabel>Workspace</SectionLabel>
        <SectionHeading>Executive Commitment Workspace</SectionHeading>
        <p className="mt-2 mb-5 text-sm text-[#7b7480]">
          Operational workspace view of all commitment entries.
        </p>
        <Card>
  ...
  return (
    <section>
      ...
      <SectionHeading>Executive Commitment Workspace</SectionHeading>
      <p className="mt-2 mb-5 text-sm text-[#7b7480]">
        {commitment.records.length} commitment {commitment.records.length === 1 ? "entry" : "entries"} in the executive workspace.
      </p>

      <div className="space-y-4">
        {commitment.records.map((entry, i) => (
          <ExecutiveCommitmentWorkspaceCard key={i} entry={entry} />
        ))}
      </div>
    </section>
  );
...
// -- Section 3: Commitment Review Workspace -----------------------------------

function CommitmentReviewWorkspaceSection({ commitment }: { commitment: ExecutiveReportCommitment }) {
  if (commitment.records.length === 0) {
    return (
      <section>
        <SectionLabel>Review</SectionLabel>
        <SectionHeading>Commitment Review Workspace</SectionHeading>
        <p className="mt-2 mb-5 text-sm text-[#7b7480]">
          Review workspace for commitment entry comparison.
        </p>
        <Card>
          <p className="text-sm text-[#7b7480]">No commitment entries to review.</p>
        </Card>
      </section>
    );
  }
  ...
  return (
    <section>
      ...
      <SectionHeading>Commitment Review Workspace</SectionHeading>
      <p className="mt-2 mb-5 text-sm text-[#7b7480]">
        Review and comparison of {commitment.records.length} commitment {commitment.records.length === 1 ? "entry" : "entries"}.
      </p>
...
function CommitmentReadinessSection({ commitment }: { commitment: ExecutiveReportCommitment }) {
  ...
  return (
    <section>
      ...
      <SectionHeading>Commitment Readiness</SectionHeading>
      <p className="mt-2 mb-5 text-sm text-[#7b7480]">
        Pipeline readiness assessment for the commitment stage.
      </p>
...
function CommitmentMetadataSection({ commitment }: { commitment: ExecutiveReportCommitment }) {
  return (
    <section>
      ...
      <p className="mt-2 mb-5 text-sm text-[#7b7480]">
        Generation metadata for this commitment workspace.
      </p>
...
const QUICK_NAV_LINKS = [
  ...
  { href: "/admin/executive-report-commitment",                  label: "Executive Report Commitment" },
  { href: "/admin/executive-report-commitment-center",           label: "Executive Report Commitment Center" },
] as const;
...
export default function ExecutiveReportCommitmentCenter({ commitment }: Props) {
  return (
    <div className="min-h-screen bg-[#f5f1eb]">
      ...
      <header className="flex items-center justify-between bg-[#4f4a52] px-6 py-4 print:hidden">
        <div className="flex items-center gap-6">
          ...
          <nav className="flex items-center gap-4">
            ...
            <span className="text-xs font-bold text-white">Executive Report Commitment Center</span>
          </nav>
        </div>
      ...
      <div className="mx-auto w-full max-w-[780px] space-y-14 px-6 py-12">
        ...
        <CommitmentWorkspaceOverviewSection commitment={commitment} />

        <hr className="border-gray-200" />

        <ExecutiveCommitmentWorkspaceSection commitment={commitment} />

        <hr className="border-gray-200" />

        <CommitmentReviewWorkspaceSection commitment={commitment} />

        <hr className="border-gray-200" />

        <CommitmentReadinessSection commitment={commitment} />
