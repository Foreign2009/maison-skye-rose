...
import ExecutiveReportPublicationDashboard   from "@/app/admin/ExecutiveReportPublicationDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Publication | Maison Skye & Rose",
...
export default async function ExecutiveReportPublicationPage() {
  ...
  return <ExecutiveReportPublicationDashboard publication={publication} />;
}
