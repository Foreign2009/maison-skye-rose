...
import ExecutiveReportArchiveDashboard    from "@/app/admin/ExecutiveReportArchiveDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Archive | Maison Skye & Rose",
...
export default async function ExecutiveReportArchivePage() {
  ...
  return <ExecutiveReportArchiveDashboard archive={archive} />;
}
