...
import ExecutiveReportValidationCenter            from "@/app/admin/ExecutiveReportValidationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Validation Center | Maison Skye & Rose",
...
export default async function ExecutiveReportValidationCenterPage() {
  ...
  return <ExecutiveReportValidationCenter validation={validation} />;
}
