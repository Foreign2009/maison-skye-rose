...
import ExecutiveReportInsightCenter          from "@/app/admin/ExecutiveReportInsightCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Insight Center | Maison Skye & Rose",
...
export default async function ExecutiveReportInsightCenterPage() {
  ...
  return <ExecutiveReportInsightCenter insight={insight} />;
}
