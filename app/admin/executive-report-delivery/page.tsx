...
import ExecutiveReportDeliveryDashboard      from "@/app/admin/ExecutiveReportDeliveryDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Delivery | Maison Skye & Rose",
...
export default async function ExecutiveReportDeliveryPage() {
  ...
  return <ExecutiveReportDeliveryDashboard delivery={delivery} />;
}
