...
import UnifiedOperationsConsole           from "@/app/admin/UnifiedOperationsConsole";
...
import { buildExecutiveBriefing }         from "@/app/lib/operations/ExecutiveBriefingBuilder";

export const metadata: Metadata = {
  title:  "Unified Operations Console | Maison Skye & Rose",
...
export default async function UnifiedOperationsPage() {
  ...
  const briefing = buildExecutiveBriefing(operations);

  return <UnifiedOperationsConsole operations={operations} briefing={briefing} />;
}
