...
import ExecutiveReportActionCenter           from "@/app/admin/ExecutiveReportActionCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Action Center | Maison Skye & Rose",
...
export default async function ExecutiveReportActionCenterPage() {
  ...
  return <ExecutiveReportActionCenter action={action} />;
}
