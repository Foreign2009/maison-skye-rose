...
import ExecutiveReportPublicationCenter      from "@/app/admin/ExecutiveReportPublicationCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Publication Center | Maison Skye & Rose",
...
export default async function ExecutiveReportPublicationCenterPage() {
  ...
  return <ExecutiveReportPublicationCenter publication={publication} />;
}
