...
import ExecutiveReportAcceptanceCenter            from "@/app/admin/ExecutiveReportAcceptanceCenter";
...
export const metadata: Metadata = {
  title:  "Executive Report Acceptance Center | Maison Skye & Rose",
...
export default async function ExecutiveReportAcceptanceCenterPage() {
  ...
  return <ExecutiveReportAcceptanceCenter acceptance={acceptance} />;
}
