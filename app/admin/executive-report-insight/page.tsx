...
import ExecutiveReportInsightDashboard       from "@/app/admin/ExecutiveReportInsightDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Insight | Maison Skye & Rose",
...
export default async function ExecutiveReportInsightPage() {
  ...
  return <ExecutiveReportInsightDashboard insight={insight} />;
}
