...
import ExecutiveReportReceiptDashboard            from "@/app/admin/ExecutiveReportReceiptDashboard";
...
export const metadata: Metadata = {
  title:  "Executive Report Receipt | Maison Skye & Rose",
...
export default async function ExecutiveReportReceiptPage() {
  ...
  return <ExecutiveReportReceiptDashboard receipt={receipt} />;
}
