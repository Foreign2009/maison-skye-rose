...
export const ARTICLE_REGISTRY: ArticleRegistryEntry[] = [
...

  {
    ...
    families: ["Amber", "Oud", "Spicy", "Woody", "Floral"],
    notes: ["base", "heart"],
    occasions: ["evening", "date night"],
    collections: [],
    keywords: [
    ...
    educationTags: ["occasions", "evening", "date-night", "oriental", "projection"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 75,
  },

  {
    ...
    families: ["Fresh", "Citrus", "Aromatic", "Woody"],
    notes: ["top", "heart"],
    occasions: ["office", "professional", "daily wear"],
    collections: [],
    keywords: [
      "office fragrance",
      "work fragrance",
    ...
    educationTags: ["occasions", "office", "professional", "fresh", "aromatic"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 72,
  },

  {
    ...
    families: ["Fresh", "Citrus", "Aromatic", "Fruity", "Aquatic"],
    notes: ["top", "heart"],
    occasions: ["casual", "weekend", "outdoors"],
    collections: [],
    keywords: [
      "casual fragrance",
      "weekend",
    ...
    educationTags: ["occasions", "casual", "weekend", "outdoors", "discovery"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 68,
  },

  {
    ...
    educationTags: ["wardrobe", "collection", "fundamentals", "discovery", "buying-guide"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 65,
  },

  {
    ...
    educationTags: ["storage", "care", "application", "degradation", "fundamentals"],
    seasonal: false,
    universalRelevance: true,
    relevanceScore: 60,
  },

  {
    ...
    families: ["Oud", "Woody", "Leather", "Tobacco"],
    notes: ["base"],
    occasions: ["evening"],
    collections: [],
    keywords: [
      ...
      "what is oud",
      "oud fragrance",
      "natural oud vs synthetic",
      "expensive fragrance ingredient",
    ],
    educationTags: ["families", "oud", "advanced", "ingredients", "luxury"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 58,
  },

  {
    ...
    keywords: [
      "scent memory",
      "olfactory memory",
      "why smell triggers memories",
      "Proustian effect",
      "fragrance and emotion",
      "limbic system",
    ],
    educationTags: ["science", "memory", "emotion", "psychology", "olfaction"],
    seasonal: false,
    universalRelevance: false,
    relevanceScore: 62,
  },
