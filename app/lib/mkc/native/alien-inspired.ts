...
export const alienInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["baccarat-rouge-540-inspired", "bloom-inspired", "ange-ou-demon-inspired", "dolce-inspired", "jasmin-noir-inspired"],
    wardrobePartners: ["coach-floral-inspired", "light-blue-inspired", "mon-guerlain-inspired", "twilly-d'hermes-inspired", "black-opium-over-red-inspired", "black-orchid-inspired", "angels-share-paradis-inspired", "la-nuit-tresor-inspired", "gucci-bamboo-inspired", "eden-sparkling-lychee-inspired", "my-way-nectar-inspired", "gabrielle-inspired", "angel-inspired", "matiere-noire-inspired", "212-vip-rose-inspired"],
  },
};
