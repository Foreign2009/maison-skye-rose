...
export const loveDontBeShyInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["delina-inspired", "hypnotic-poison-inspired", "bianco-latte-inspired", "arabians-musk-inspired", "black-opium-over-red-inspired", "scandal-inspired", "changing-constance-inspired", "attrape-reves-inspired", "angel-inspired", "cloud-inspired"],
