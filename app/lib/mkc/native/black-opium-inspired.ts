...
export const blackOpiumInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["ultra-male-inspired", "layton-inspired", "hypnotic-poison-inspired", "poison-girl-inspired", "black-opium-over-red-inspired", "changing-constance-inspired", "angel-inspired"],
