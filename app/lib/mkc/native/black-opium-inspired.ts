...
export const blackOpiumInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["ultra-male-inspired", "layton-inspired", "hypnotic-poison-inspired", "poison-girl-inspired", "black-opium-over-red-inspired", "changing-constance-inspired", "angel-inspired", "opium-inspired"],
    wardrobePartners: ["delina-inspired", "mon-guerlain-inspired", "rose-n'-roses-inspired", "taif-rose-inspired", "idole-inspired", "la-nuit-tresor-inspired", "narciso-rodriguez-for-her-inspired", "dylan-purple-inspired", "very-good-girl-elixir-inspired", "chanel-no-5-inspired", "crazy-in-love-inspired", "ange-ou-demon-inspired", "amor-amor-inspired"],
  },
};
