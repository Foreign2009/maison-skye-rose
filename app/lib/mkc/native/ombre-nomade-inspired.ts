...
export const ombreNomadeInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["oud-wood-inspired", "royal-oud-inspired", "ombre-leather-inspired", "oud-bergamot-inspired", "bvlgari-black-inspired"],
    wardrobePartners: ["sauvage-elixir-inspired", "spicebomb-extreme-inspired", "voyage-d'hermes-inspired", "black-orchid-inspired", "gold-oud-inspired", "armani-prive-oud-royal-inspired", "cool-water-inspired", "blue-noir-inspired", "versace-rose-flamboyante-inspired"],
  },
};
