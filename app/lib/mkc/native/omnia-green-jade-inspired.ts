...
export const omniaGreenJadeInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["coco-mademoiselle-inspired", "chance-eau-fraiche-inspired", "yellow-diamond-inspired", "omnia-crystalline-inspired", "dylan-blue-pour-femme-inspired", "cool-water-woman-inspired"],
