...
export const tobaccoVanilleInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["spicebomb-extreme-inspired", "naxos-inspired", "side-effect-inspired", "angels-share-inspired", "amen-fantasm-inspired", "centaurus-inspired", "burberry-london-inspired", "bvlgari-black-inspired", "scandal-pour-homme-inspired", "smoking-hot-inspired", "tobacco-honey-inspired", "azzaro-wanted-by-night-inspired"],
