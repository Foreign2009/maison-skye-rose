...
export const chanceEauTendreInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["delina-inspired", "chance-eau-fraiche-inspired", "bright-crystal-inspired", "chance-inspired", "coach-floral-inspired", "fresh-blossom-inspired", "rose-of-no-man's-land-inspired", "twilly-d'hermes-inspired", "peony-blush-suede-inspired", "english-pear-freesia-inspired", "idole-inspired", "fame-inspired", "gucci-guilty-pour-femme-inspired", "eladaria-inspired", "eden-sparkling-lychee-inspired", "my-way-nectar-inspired", "gucci-flora-inspired", "212-vip-rose-inspired"],
