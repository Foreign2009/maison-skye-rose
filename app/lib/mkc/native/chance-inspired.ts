...
export const chanceInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["coco-mademoiselle-inspired", "chance-eau-fraiche-inspired", "chance-eau-tendre-inspired", "a-la-rose-inspired", "chloe-original-inspired", "greenley-inspired", "daisy-inspired"],
