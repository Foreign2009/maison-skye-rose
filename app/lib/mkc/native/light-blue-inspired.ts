...
export const lightBlueInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["coco-mademoiselle-inspired", "chance-eau-fraiche-inspired", "yellow-diamond-inspired", "fig-lotus-flower-inspired", "omnia-crystalline-inspired", "ck-one-inspired", "dylan-blue-pour-femme-inspired", "cool-water-woman-inspired"],
    wardrobePartners: ["alien-inspired", "flowerbomb-inspired", "dkny-be-delicious-green-inspired", "light-blue-capri-in-love-inspired"],
  },
};
