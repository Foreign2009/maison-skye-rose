...
export const arabiansTonkaInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["oud-wood-inspired", "naxos-inspired", "angels-share-paradis-inspired", "oud-bergamot-inspired", "armani-prive-oud-royal-inspired", "oud-cadenza-inspired"],
