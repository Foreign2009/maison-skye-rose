...
export const sauvageInspired: FragranceKnowledge = {
  ...
  relationships: {
    ...
    wardrobePartners: ["afternoon-swim-inspired", "miss-dior-inspired", "ani-inspired", "arabians-tonka-inspired", "blanche-bete-inspired", "burberry-goddess-inspired", "chance-eau-tendre-inspired", "coco-mademoiselle-inspired", "crystal-noir-inspired", "erba-pura-inspired", "flowerbomb-inspired", "libre-intense-inspired", "love-don't-be-shy-inspired", "mon-paris-inspired", "prada-paradoxe-inspired", "good-girl-blush-inspired", "alien-man-inspired", "allure-homme-sport-inspired", "bvlgari-aqua-inspired", "h24-herbes-vives-inspired", "ombre-leather-inspired", "soleil-blanc-inspired", "fahrenheit-inspired", "le-male-inspired", "abu-dhabi-inspired", "light-blue-pour-homme-inspired", "bois-pacifique-inspired", "burberry-london-inspired", "bvlgari-black-inspired", "212-vip-black-inspired", "scandal-pour-homme-inspired", "legend-blue-inspired", "bvlgari-aqva-marine-inspired", "the-one-pour-homme-inspired", "azzaro-wanted-inspired", "bad-boy-inspired", "chanel-allure-inspired", "versace-rose-flamboyante-inspired", "stronger-with-you-sandalwood-inspired", "polo-sport-inspired", "azzaro-wanted-by-night-inspired"],
    alternatives: ["dunhill-fresh-inspired", "eros-flame-inspired", "voyage-d'hermes-inspired", "montblanc-explorer-inspired", "gucci-guilty-pour-homme-inspired", "eros-energy-inspired", "eternity-inspired", "lacoste-blanc-inspired"],
  },
