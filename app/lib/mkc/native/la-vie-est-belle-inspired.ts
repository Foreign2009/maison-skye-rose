...
export const laVieEstBelleInspired: FragranceKnowledge = {
  ...
  relationships: {
    alternatives:     ["delina-inspired", "hypnotic-poison-inspired", "bianco-latte-inspired", "devotion-inspired", "mon-guerlain-inspired", "lady-million-inspired", "la-belle-inspired", "la-nuit-tresor-nude-inspired"],
    wardrobePartners: ["ultra-male-inspired", "layton-inspired", "fresh-blossom-inspired", "daisy-inspired"],
  },
};
