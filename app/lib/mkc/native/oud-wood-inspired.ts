...
export const oudWoodInspired: FragranceKnowledge = {
  ...
  relationships: {
    ...
    wardrobePartners: ["baccarat-rouge-540-extrait-inspired", "crystal-noir-inspired", "bois-d'argent-inspired", "oud-ispahan-inspired", "khamrah-inspired", "tom-ford-noir-inspired", "matiere-noire-inspired"],
  },
