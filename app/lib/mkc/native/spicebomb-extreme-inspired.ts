...
export const spicebombExtremeInspired: FragranceKnowledge = {
  ...
  // ── Relationships ─────────────────────────────────────────────────────────────
  relationships: {
    wardrobePartners: ["althair-inspired", "armani-si-inspired", "libre-intense-inspired", "ombre-nomade-inspired", "pacific-chill-inspired", "silver-mountain-water-inspired", "very-good-girl-inspired", "gris-charnel-inspired", "bleu-de-chanel-l'exclusif-inspired", "bois-d'argent-inspired", "dior-homme-sport-inspired", "eros-flame-inspired", "gentleman-edt-inspired", "godolphin-inspired", "fame-inspired", "lacoste-noir-inspired", "montblanc-legend-inspired", "montblanc-explorer-inspired", "leau-dissey-pour-homme-inspired", "tom-ford-noir-inspired", "polo-black-inspired", "fahrenheit-inspired", "gucci-guilty-pour-homme-inspired", "eros-energy-inspired", "oud-sapparot-inspired", "outlands-inspired", "changing-constance-inspired"],
    alternatives: ["ani-inspired", "carlisle-inspired", "allure-homme-sport-inspired", "spicebomb-dark-leather-inspired", "tobacco-vanille-inspired", "angels-share-inspired", "amen-fantasm-inspired", "le-male-inspired", "centaurus-inspired", "dark-vanilla-inspired"],
  },
