...
export const spicebombExtremeInspired: FragranceKnowledge = {
  ...
  // ── Relationships ─────────────────────────────────────────────────────────────
  relationships: {
    wardrobePartners: ["althair-inspired", "armani-si-inspired", "libre-intense-inspired", "ombre-nomade-inspired", "pacific-chill-inspired", "silver-mountain-water-inspired", "very-good-girl-inspired", "gris-charnel-inspired", "bleu-de-chanel-l'exclusif-inspired", "bois-d'argent-inspired", "dior-homme-sport-inspired", "eros-flame-inspired", "gentleman-edt-inspired", "godolphin-inspired", "fame-inspired", "lacoste-noir-inspired", "montblanc-legend-inspired", "montblanc-explorer-inspired", "leau-dissey-pour-homme-inspired", "tom-ford-noir-inspired", "polo-black-inspired", "fahrenheit-inspired", "gucci-guilty-pour-homme-inspired", "eros-energy-inspired", "oud-sapparot-inspired", "outlands-inspired", "changing-constance-inspired", "aqva-amara-inspired", "lacoste-blanc-inspired", "creed-delphinus-inspired", "cool-water-inspired", "dylan-blue-inspired", "polo-blue-inspired", "prada-paradigme-inspired", "legend-blue-inspired", "myrrh-tonka-inspired", "azzaro-chrome-inspired", "ralph's-club-inspired", "uomo-by-zegna-inspired", "chanel-allure-inspired", "kouros-silver-inspired", "212-heroes-inspired", "euphoria-men-inspired", "opium-inspired", "leau-dissey-pour-homme-sport-inspired"],
    alternatives: ["ani-inspired", "carlisle-inspired", "allure-homme-sport-inspired", "spicebomb-dark-leather-inspired", "tobacco-vanille-inspired", "angels-share-inspired", "amen-fantasm-inspired", "le-male-inspired", "centaurus-inspired", "dark-vanilla-inspired", "bois-pacifique-inspired", "burberry-london-inspired", "212-vip-black-inspired", "scandal-pour-homme-inspired", "smoking-hot-inspired", "the-one-pour-homme-inspired", "boss-the-scent-inspired", "bad-boy-inspired", "tobacco-honey-inspired", "stronger-with-you-sandalwood-inspired", "azzaro-wanted-by-night-inspired"],
  },
