...
export const chanceEauFraicheInspired: FragranceKnowledge = {
  ...
  // ── Relationships ─────────────────────────────────────────────────────────────
  relationships: {
    alternatives:     ["chance-eau-tendre-inspired", "chance-inspired", "light-blue-inspired", "omnia-green-jade-inspired", "libre-flowers-flames-florale-inspired", "dylan-purple-inspired", "fig-lotus-flower-inspired", "aqua-allegoria-rosa-verde-inspired", "clinique-happy-inspired", "dylan-blue-pour-femme-inspired", "daisy-inspired", "light-blue-capri-in-love-inspired"],
